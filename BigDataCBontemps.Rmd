...
## My presentation is intitled "Teaching" with a ?
* Diffrence between the two...
* Of course, even on a course on "Training" we do "teach" 
* At the SIAP, courses include both training and teaching
* * I'llcome back to that later* 
...
# Many resources .orange[at the SIAP:]


<br>

## .orange[**Big Data**] Course .font_cool[(with Kostat), since 2016]
##.font_cool[includes .orange[GIS], .orange[webscrapping], .orange[text mining], .orange[scanner data], .orange[...]]

## .orange[**ICT**] Innovations for Modernizing Official Statistical Systems .font_cool[(since 2017)]

## .orange[**Data Visualization**] .font_cool[(with Paris2!)]

## Seminar on Statistical Capacity Building for .orange[**New Data Sources**] .font_cool[(since 2017)]
...
- We had a more general course on **ICT Innovations for Modernizing Official Statistical Systems**
...
# Many resources .orange[out there]:
...
## At [Eurostat](https://ec.europa.eu/eurostat/cros/content/estp-training-courses_en) .orange[...]
...
**Rq2:**: Member of hte UN Task Team on Skills, Training and Capacity Development, I will not talk on behalf of this group  see later by **Ceri**
...
### Statistical Learning (ML, IA,...) .font_cool[(*Big Data literacy*)]
...
--
### .right[Ethics/legal issues .font_cool[(*Data dissemination, Bias in IA*,...)]]
...
### .center[(Games? Contests? Simulations?...)]
