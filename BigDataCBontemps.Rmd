...
*Statistical Institute for Asia and the Pacific (UN SIAP)*


![:scale 20%](img/SIAP_logo_Big.png)]
...
---
 ...
 I used [this webpage](https://pkg.garrickadenbuie.com/xaringanExtra/) to start
 
 and alos [this Github](https://github.com/gadenbuie/xaringanExtra/)
...
#xaringanExtra::use_animate_all()
```


---
class: animated slideOutDown fadeOutLeft
...
# **Test** of .can-edit.key-firstSlideTitle[ an editable title]

Hello, M.  .can-edit[Xtophe] (your name)

## A few editable elements 
